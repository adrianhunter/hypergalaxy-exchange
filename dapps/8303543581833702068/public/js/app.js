...
/***/ function(module, exports, __webpack_require__) {
	...
	var m, Home, Header, Markets, Exchange, AccountsForm, Balance, CreateTokenComp;
	m = __webpack_require__(1);
	Home = {};
	Header = __webpack_require__(10);
	Markets = __webpack_require__(12);
	Exchange = __webpack_require__(14);
	AccountsForm = __webpack_require__(7);
	Balance = __webpack_require__(16);
	CreateTokenComp = __webpack_require__(17);
	Home.view = function(){
	  return m('.demo-layout-transparent.mdl-layout.mdl-js-layout.mdl-layout--fixed-header', [Header, m.component(CreateTokenComp), m.component(Balance), m.component(AccountsForm), m.component(Markets), m.component(Exchange)]);
	};
	module.exports = Home;
...
/***/ function(module, exports, __webpack_require__) {
	...
	AccountsForm.controller = function(args){
	  args == null && (args = {});
	  AccountsForm.vm.mode(args.mode || 'login');
	  return {};
	};
	...
	submitForm = function(e){
	  ...
	  m.request({
	    method: "GET",
	    url: App.api_url + "/openAccount?secret=" + AccountsForm.vm.password()
	  }).then(function(r){
...
/***/ function(module, exports, __webpack_require__) {
	...
	TextField = function(arg$){
	  var key, val, bind, label, type, inputSettings, classes;
	  ...
	  classes += '.is-dirty';
	  if (bind) {
	    inputSettings.onchange = m.withAttr("value", function(e, r){
	      return bind(e, r);
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	m = __webpack_require__(1);
	Markets = {};
	Table = __webpack_require__(13);
	Markets.controller = function(args){
	  return {
	    markets: m.request({
	      method: "GET",
	...
	Markets.view = function(ctrl, args){
	  var rows, tableHead;
	  rows = _.map(ctrl.markets(), function(market){
	    return m('tr', [m('td', market.tiker), m('td', market.name)]);
	  });
	  tableHead = [m('th', 'foo')];
	  return m('.markets', [
	    'Markets', m.component(Table, {
	      rows: rows,
	      head: tableHead
	    })
	  ]);
	...
	//# sourceMappingURL=/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/node_modules/livescript-loader/index.js!/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/src/components/markets.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var m, Table, configureTable;
	m = __webpack_require__(1);
	Table = {};
	Table.controller = function(args){};
	Table.view = function(ctrl, args){
	  return m("table.mdl-data-table.mdl-js-data-table.mdl-data-table--selectable.mdl-shadow--2dp", {
	    config: configureTable,
	    style: args.style
	  }, [m("thead", [m("tr", args.head)]), m("tbody", args.rows)]);
	};
	configureTable = function(elm, isInit){
	  if (!isInit) {
	    return typeof componentHandler != 'undefined' && componentHandler !== null ? componentHandler.upgradeElements(elm) : void 8;
	  }
	};
	module.exports = Table;
	//# sourceMappingURL=/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/node_modules/livescript-loader/index.js!/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/src/mdl/table.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var m, Exchange, Table, Card, Button, TextField, handleBuy, VM;
	m = __webpack_require__(1);
	Exchange = {};
	Table = __webpack_require__(13);
	...
	Button = __webpack_require__(9);
	TextField = __webpack_require__(8);
	Exchange.controller = function(args){
	  return {};
	};
	Exchange.view = function(ctrl, args){
	  return m('.exchange', [m.component(Card, {
	    title: 'buy hyper',
	    content: [m('form', [
	      TextField({
	        key: 'price',
	        ...
	        label: 'total',
	        bind: VM.buy.total,
	        val: VM.buy.price() * VM.buy.amount()
	      })
	    ])],
	    actions: [Button({
	      text: 'Buy',
	...
	handleBuy = function(){
	  ...
	  return m.request(request).then(function(r){
	    return console.log(r);
	  });
	};
	VM = Exchange.vm;
	...
	//# sourceMappingURL=/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/node_modules/livescript-loader/index.js!/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/src/components/exchange.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Card.view = function(ctrl, args){
	  return m("div.demo-card-square.mdl-card.mdl-shadow--2dp", [m("div.mdl-card__title.mdl-card--expand", [m("h2.mdl-card__title-text", args.title)]), m("div.mdl-card__supporting-text", args.content), m("div.mdl-card__actions.mdl-card--border", args.actions)]);
	};
	module.exports = Card;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var m, TextField, Button, Balance, handleDeposit;
	m = __webpack_require__(1);
	TextField = __webpack_require__(8);
	Button = __webpack_require__(9);
	Balance = {};
	Balance.controller = function(args){
	  args == null && (args = {});
	  return {};
	};
	Balance.view = function(ctrl, args){
	  return m('.balance', [
	    TextField({
	      key: 'amount',
	      type: 'amount',
	      label: 'amount',
	      bind: Balance.vm.amount
	    }), Button({
	      text: 'Deposit',
	...
	//# sourceMappingURL=/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/node_modules/livescript-loader/index.js!/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/src/components/balance.ls.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	var m, TextField, Button, CreateTokenComp, VM, handleCreateToken;
	m = __webpack_require__(1);
	TextField = __webpack_require__(8);
	Button = __webpack_require__(9);
	CreateTokenComp = {};
	CreateTokenComp.controller = function(args){
	  args == null && (args = {});
	  return {};
	};
	CreateTokenComp.view = function(ctrl, args){
	  return m('.balance', [
	    TextField({
	      key: 'name',
	      type: 'name',
	      label: 'name',
	      bind: CreateTokenComp.vm.name
	    }), TextField({
	      key: 'description',
	      type: 'description',
	      label: 'description',
	      bind: CreateTokenComp.vm.description
	    }), TextField({
	      key: 'fund',
	      type: 'fund',
	      label: 'fund',
	      bind: CreateTokenComp.vm.fund
	    }), Button({
	      text: 'Create token',
	...
	//# sourceMappingURL=/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/node_modules/livescript-loader/index.js!/Users/adrianjager/dev/github/lisk/dapps/8303543581833702068/client/src/components/create-token.ls.map
